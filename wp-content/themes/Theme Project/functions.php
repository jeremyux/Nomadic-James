...
function add_my_script() {
    wp_enqueue_script(
        'instagram', // name your script so that you can attach other scripts and de-register, etc.
        get_template_directory_uri() . '/js/instagram.js', // this is the location of your script file

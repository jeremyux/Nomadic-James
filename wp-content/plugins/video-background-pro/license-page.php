          ...
          ?>
            ...
            if ( $tab == $this->ame_activation_tab_key ) {
              ...
              submit_button( __( 'Save Changes', $this->text_domain ) );
                ...
                echo '<ol>';
                  _e( '<li><a href="http://docs.pushlabs.co/video-background-pro/using-the-metabox/" target="_blank">Using the metabox</a></li>', 'video-background-pro' );
                  _e( '<li><a href="http://docs.pushlabs.co/video-background-pro/using-wpbakery/" target="_blank">Using the WPBakery (Visual Composer) integration</a></li>', 'video-background-pro' );
                  _e( '<li><a href="http://docs.pushlabs.co/video-background-pro/using-siteorigin/" target="_blank">Using the SiteOrigin Page Builder Integration</a></li>', 'video-background-pro' );
                  _e( '<li><a href="http://docs.pushlabs.co/video-background-pro/using-the-shortcode/" target="_blank">Using the shortcode.</a></li>', 'video-background-pro' );
                echo '</ol>';
                _e( '<p>For full documentation, instructions, and video tutorials, please visit <a href="http://docs.pushlabs.co/video-background-pro" target="_blank">the docs</a>.</p>', 'video-background-pro' );
